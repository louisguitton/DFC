...
public class DfcMain {
    public void run() {
        ...
        // the total number of specifed categories/relevant-topics,the variable R in
        // paper
        model.iCateNum = 2;

        // the setting total number of irrelevant-topics,the variable T in paper. If you
        // run the classification task, this parameter need to be setting as zero
        model.bCateNum = 20;

        // the total number of irrelevant-topics, which is only used for evaluation and
        // load documents. If you run the classification task, this parameter need to be
        // setting as zero
        model.btruth = 18;
        ...
        // the total number of categories, which is only used for evaluation and load
        // documents
        ...
        // the prior likelihood for document d being a relevant document, the variable
        // k_d in paper
        model.kd = 0.5;
