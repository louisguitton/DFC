...
public class PaperAbs {
  ...
  public PaperAbs renew(PaperAbs reusable, int id, String abs, String title) {
    reusable.id = id;
    reusable.abs = abs;
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof PaperAbs) {
      ...
      return (id == other.id && abs == null ? other.abs == null
          : abs.equals(other.abs) && title == null ? other.title == null : title.equals(other.title));
    } else
      return false;
  }
